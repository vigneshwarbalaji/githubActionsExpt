    ...
    <tr>
        <td>
            <section style="width:650px;margin:0 auto;background-color:#fff;border-radius: 4px;padding:30px 50px;box-sizing:border-box;">
                <h1 style="font-size:24px;text-align:center;color:#4a4a4a;font-weight:600;margin:0 0 50px 0;">Password Updated Successfully</h1>
                <div style="margin-bottom:30px;">
                    ...
                    <p style="color:rgba(74,74,74,0.8);font-size:14px;margin-bottom:30px;line-height:22px;">You recently created a new password for your YoCoBoard account. Now that it's done, let's try it out. Log in to your YoCoBoard with your new password by clicking the Login button.</p>
                    <a href="${REDIRECT_URL}" style="background-color:#bf001b;background-image:linear-gradient(to right,#f34b58,#bf001b);font-size: 14px;color: #fff;padding: 8px 20px;border: none;border-radius: 100px;text-decoration: none;">Login</a>
                </div>
                <div>
                    <p style="color:rgba(74,74,74,0.8);font-size:14px;margin-bottom:25px;">If you have some difficulties getting through, send an email to <a style="color:#f14956;text-decoration:none;">${SUPPORT_MAIL}</a> and help will be on its way. </p>
