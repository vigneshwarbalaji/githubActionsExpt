                ...
                <tr>
                    <td>
                        <section style="width:650px;margin:0 auto;background-color:#fff;border-radius: 4px;padding:30px 50px;box-sizing:border-box;">
                            <h1 style="font-size:24px;text-align:center;color:#4a4a4a;font-weight:600;margin:0 0 50px 0;">Adjustment Request Status</h1>
                            <div style="margin-bottom:30px;">
                                ...
                                <p style="color:rgba(74,74,74,0.8);font-size:14px;margin-bottom:30px;line-height:22px;">
                                    Your adjustment got approved by
                                    <b>${ADMIN_NAME}</b> in
                                    <b>${COMPANY_NAME}</b> with difference of
                                    <b>${DURATION_DIFF}</b> for "${MESSAGE}" as reason
                                </p>
