            ...
            <tr>
               <td>
                  <section style="width:650px;margin:0 auto;background-color:#fff;border-radius: 4px;padding:30px 50px;box-sizing:border-box;">
                     <h1 style="font-size:24px;text-align:center;color:#4a4a4a;font-weight:600;margin:0 0 50px 0;">Adjustment Confirmation</h1>
                     <div style="margin-bottom:30px;">
                        ...
                        <p style="color:rgba(74,74,74, 0.8);font-size:14px;margin-bottom:30px;line-height:22px;">There is an adjustment created by <b style="text-transform:capitalize">${ADMIN_NAME} </b> against your session for "${MESSAGE}" as reason. To view the adjustment, you can click the Check Request button. Once clicked, you can confirm the adjustment made or choose to modify it in case the adjustment is not accurate.</p>
                     ...
                     <div>
                        <p style="color:rgba(74,74,74,0.8);font-size:14px;margin-bottom:25px;">For clarifications on the adjustments, you can contact <a style="color:#f14956;text-decoration:none;">${ADMIN_MAIL}</a>.
                           To resolve any questions about YoCoBoard, you can email us at <a style="color:#f14956;text-decoration:none;">support@yocoboard.com</a> for expert assistance.
                        </p>
                        <span style="color:rgba(74,74,74,0.8);font-size:14px;">Happy Time Tracking,</span>
                        <cite style="color:rgba(74,74,74,0.8);font-size:14px;font-weight:600;font-style:normal;display:block;margin-top:15px;">YoCoBoard Team</cite>
                     </div>
                  </section>
               </td>
            </tr>
