...
@Slf4j
public class ReportAppProperties {

    private ReportAppProperties(){}

    public static final void setupEnvVariables(AppMode appMode) throws IOException {
        if(AppMode.LIVE.equals(appMode)){
            setupReportEnvVariableForLive();
        }else{
            setupReportEnvVariableForStaging();
        }
    }

    private static void setupReportEnvVariableForStaging() throws IOException {
        ...
        setReportKMSProperties(properties);
        ...
        CommonAppProperties.setAppUrl("https://report-dot-staging-goclockin-dashboard.appspot.com");
    ...
    private static void setupReportEnvVariableForLive() throws IOException {
        ...
        CommonAppProperties.setAppUrl("https://report.yocoboard.com");
    ...
    private static void setReportKMSProperties(Properties properties){
